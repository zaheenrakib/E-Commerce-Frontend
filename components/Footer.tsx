        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-600 dark:text-gray-400">
              <li><Link href="/products?category=new" className="hover:text-blue-600">New Arrivals</Link></li>
              <li><Link href="/products?category=bestsellers" className="hover:text-blue-600">Best Sellers</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-600 dark:text-gray-400">
              ...
              <li><Link href="/returns" className="hover:text-blue-600">Returns & Exchanges</Link></li>
              <li><Link href="/tracking" className="hover:text-blue-600">Order Tracking</Link></li>
            </ul>
          </div>
