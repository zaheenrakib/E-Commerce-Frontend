    ...
    <header className="sticky top-0 z-50 w-full bg-white border-b border-gray-100 shadow-sm transition-all">
      ...
      <div className="container mx-auto px-4 md:px-6 h-20 flex items-center justify-between gap-8">
          ...
          <Link href="/" className="flex items-center gap-2 group">
            <div className="bg-black text-white p-2 rounded-xl transition-transform group-hover:scale-110">
              <ShoppingCart className="h-5 w-5" />
            </div>
            <span className="text-xl font-bold tracking-tight text-gray-900">
              Luxe<span className="text-gray-500">Mart</span>
            </span>
          </Link>
          ...
          <div className="flex items-center gap-6 shrink-0">
            ...
            {/* User Auth */}
            <Link href="/login" className="hidden md:flex items-center gap-2 px-4 py-2 rounded-full bg-gray-900 text-white text-sm font-medium hover:bg-gray-800 transition-colors shadow-sm">
